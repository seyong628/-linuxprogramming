...
bool operator==(Book& a, int i); //정수 ==연산자함수 선언
bool operator==(Book& a, string s);//문자열 ==연산자함수 선언
bool operator==(Book& a, Book& b); //객체 ==연산자함수 선언
...
public:             //public
    ...
    friend bool operator==(Book& a, int i); //friend 정수 ==연산자함수 선언
    friend bool operator==(Book& a, string s);//friend 문자열 ==연산자함수 선언
    friend bool operator==(Book& a, Book& b); //friend 객체 ==연산자함수 선언
};                  //클래스 선언 끝
#endif			//조건부 컴파일 지시자 끝